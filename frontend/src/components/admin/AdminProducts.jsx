...
export default function AdminProducts() {
  ...
  // Helper function to parse tags (in case backend returns string instead of array)
                ...
                <tr key={p.id}>
                  ...
                  <td>
                    {parseTags(p.tags).length > 0 
                      ? parseTags(p.tags).map(tag => tag.charAt(0).toUpperCase() + tag.slice(1)).join(', ')
                      : "-"
                    }
                  </td>
                    ...
                    <button 
                      ...
                      onClick={() => {
                        ...
                        setProduct({
                          ...
                          tags: productTags,
                          image: null,
                          imagePreview: p.image.startsWith('http') ? p.image : `http://localhost:8000${p.image}`,
                        });
